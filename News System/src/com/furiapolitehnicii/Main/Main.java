...
public class Main {
	public static void main(String[] args)
	{
		...
		News trumpNews = new News("Trump won the elections!", "Mihai Gadea", "Politics", new ArrayList<String>(), "America", "Donald Trump won the key swing states of Florida, North Carolina and Ohio early this morning, giving him a clear path to the White House.");
		News sportNews = new News("Lionel Messi and father get 21-month prison term!" , "Mircea Badea", "Sports" , new ArrayList<String>() , "Vadim Tudor", "Lionel Messi and his father have been fined 3.6m euros and given a 21-month prison sentence for a Barcelona tax fraud case.");
